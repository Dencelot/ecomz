   ...
   return (
      <section className='container  relative py-[60px]'>
         ...
         <div className='relative z-[1]'>
            ...
            <button className='2xl:mt-[32px] md:mt-[24px] mt-[20px] xs:text-[32px] text-[24px] leading-[1.3] text-[var(--white-100)] md:rounded-[20px] rounded-[30px] md:py-[45px] py-[19px] bg-[var(--bazalt-100)] w-full transition-colors hover:bg-[var(--black-90)]'>
               {data.middle.possibilities.btn}
            </button>
         </div>
      </section>
   )
