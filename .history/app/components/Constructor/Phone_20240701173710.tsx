                     ...
                     constructorData.phone.catalog.map(el=>(
                        <SwiperSlide className='' style={{height:'auto'}}>
                           <article className='flex flex-col h-full'>
                              ...
                              <button style={{background:`${filters.}`}} className=' font-[400] text-[12px] text-[var(--white-100)] text-center w-full rounded-[5px] flex items-center justify-center min-h-[30px]'>
                                    {el.buy}
                              </button>
