...
const Phone = () => {
   const filters = useAppSelector(ac)
   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`relative z-[2] lg:px-[40px] px-[30px]  lg:py-[80px] py-[50px] `}>
            <div className='lg:h-[606px] h-[466px] overflow-auto phoneScroll'>
                     ...
                     constructorData.phone.catalog.map(el=>(
                        <SwiperSlide className='' style={{height:'auto'}}>
                           <article className='flex flex-col h-full'>
                              ...
                              <button style={{background:`${}`}} className=' font-[400] text-[12px] text-[var(--white-100)] text-center w-full rounded-[5px] flex items-center justify-center min-h-[30px]'>
                                    {el.buy}
                              </button>
            ...
            <ul className='flex items-center justify-between lg:mt-[25px] mt-[15px] font-[400] lg:text-[10px] text-[8px]'>
               {
                  constructorData.phone.footer.map(el=>(
                     <li key={el.id} className='flex flex-col items-center justify-end px-[4px]'>
                        <Image className='max-w-full object-contain w-auto h-[20px]' src={el.img} quality={100} alt={el.text} width={25} height={25} />
                        {el.text}
                     </li>
                  ))
               }
