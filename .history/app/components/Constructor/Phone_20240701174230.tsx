                     ...
                     constructorData.phone.smallBanners.map(el=>(
                        <SwiperSlide className=' aspect-square '>
                           <div className={`relative p-[10px] w-full h-full flex items-center justify-center font-[400] text-[var(--white-100)] text-[16px] text-center`}>
                              ...
                              <Image className={`phoneSvg fill-black z-0 w-full h-full absolute top-[0px] left-[0px]`} src={el.img} quality={100} alt={el.text} width={138} height={138} />
                           </div>
                        </SwiperSlide>
                     ))
                  }
            ...
            <ul className='flex items-center justify-between lg:mt-[25px] mt-[15px] font-[400] lg:text-[10px] text-[8px]'>
               {
                  constructorData.phone.footer.map(el=>(
                     <li key={el.id} className='flex flex-col items-center justify-end px-[4px]'>
                        <Image className='max-w-full fill phoneSvg object-contain w-auto h-[20px]' src={el.img} quality={100} alt={el.text} width={25} height={25} />
                        {el.text}
                     </li>
                  ))
               }
