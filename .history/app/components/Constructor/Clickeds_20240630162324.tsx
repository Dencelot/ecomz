      ...
      <div className='flex items-center flex-wrap m-[-8px]'>
      {
         data.list.map((el:any)=>
            <button  key={el.id} className={` p-[8px]`}>
               <span className={`transition-all hover:border-[var(--sunset-08)] hover:border-[2px] w-[32px] h-[32px] p-[4px] flex items-center justify-center rounded-full border-solid ${filters.colors.id===el.id? 'border-[1px] border-[var(--black-80)]' : 'border-[1px] border-[var(--black-80)]'}`}>
