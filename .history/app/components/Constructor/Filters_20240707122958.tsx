...
const Filters = () => {
   ...
   return (
      <>
      <button className={`rounded-tr-[12px] w-[64px] rounded-br-[12px] bg-[var(--neon-01)] hover:bg-[var(--neon-02)]  flex items-center justify-center absolute top-[100px] bottom-[100px] left-0 z-[4]`}>
