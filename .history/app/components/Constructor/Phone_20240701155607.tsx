...
const Phone = () => {
   ...
   return (
      <div className={`xl:px-[56px] px-[26px] flex-none xl:w-[510px] w-[410px] relative text-[var(--bazalt-100)]`}>
         <div className=' absolute z-0 xl:left-[56px] xl:right-[56px] right-[26px] right-[26px]'>
