...
const Filters = () => {
   ...
   return (
      <>
      <button className={`rounded-tr-[12px] w-[64px] rounded-br-[12px] bg-[var(--neon-01)] hover:bg-[var(--neon-02)] transition-colors  flex items-center justify-center absolute top-[100px] bottom-[100px] left-0 z-[4]`}>
         <Image quality={100} width={64} height={64} alt='filter' src={'/img/filter.png'}/>
      </button>
