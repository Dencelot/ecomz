...
const Phone = () => {
   ...
   return (
      <div className={`px-[56px] w-1/3 relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`z-[1] flex items-center justify-center text-[13px] font-[900] font-[var(--third-family)]  absolute left-[140px] top-[1%] w-[50px] h-[20px] bg-[var(--sunrise-100)]`}>
            {time}
         </div>
      </div>
   )
