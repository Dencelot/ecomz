...
const Filters = () => {
   ...
   return (
      <div className={`${active?'  ':''} top-[80px] w-full xs:top-auto xs:left-auto fixed  xs:w-1/3 h-fit xs:bg-[var(--neon-01)] 2xl:text-[25px]  text-[20px] xs:relative z-[5] rounded-[32px] p-[32px]`}>
