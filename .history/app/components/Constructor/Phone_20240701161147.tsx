            ...
            <Swiper>
               {
                  constructorData.phone.smallBanners.map(el=>(
                     <SwiperSlide>
                        <div className={`relative w-[143px] h-[143px] flex items-center justify-center font-[400] text-[var(--white-100)] text-[16px] text-center`}>
                           <p className='relative z-[1] w-1/2'>
                              {el.text}
                           </p>
