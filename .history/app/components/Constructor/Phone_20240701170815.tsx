   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`relative z-[2] lg:px-[40px] px-[30px]  lg:py-[80px] py-[50px]`}>
            ...
            <div className={`rounded-[16px] overflow-hidden relative z-[2] h-[128px] p-[10px] w-full flex items-center justify-center font-[400] text-[var(--white-100)] text-[22px] text-center`}>
               <p className='relative z-[1] leading-7 w-1/3'>
