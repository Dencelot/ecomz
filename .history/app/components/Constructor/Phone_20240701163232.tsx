                     ...
                     <SwiperSlide className=''>
                        <article>
                           <div className='overflow-hidden rounded-[2px] relative '>
                              <p className=' absolute z-[1] top-0 left-0 text-center flex items-center justify-center font-[500] text-[12px] bg-[#28a745] rounded-[2px]  text-[var(--white-100)] h-[16px] w-[40px]'>
                                 {el.discount}
                              </p>
