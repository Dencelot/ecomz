...
const Options = ({data}:{data:any}) => {
   ...
   const handleClick = (id:number) => {
      console.log(constructorD.filters[data.type].list.find((el:any)=> el.id === id))
      dispatch(addFilters({...filters, filters[data.type]:constructorD.filters[data.type].list.find((el:any)=> el.id === id)}))
   }
   return (
      <div className=''>
