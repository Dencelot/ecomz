...
const Filters = () => {
   ...
   return (
      <div className={`${active?'  ':'-left-[80%] bg-[var(--neon-01)]'} top-[80px] w-full md:top-auto md:left-auto fixed  md:w-1/3 h-fit md:bg-[var(--neon-01)] 2xl:text-[25px]  text-[20px] md:relative z-[5] rounded-[32px] p-[32px]`}>
