...
const Filters = () => {
   ...
   return (
      <div className={`${active?'md:top-auto md:left-auto top-[80px] left-0 md:bg-[var(--neon-01)] md:bg-[var(--neon-01)]':'-left-[80%]'}  fixed  md:w-1/3 h-fit md:bg-[var(--neon-01)] 2xl:text-[25px]  text-[20px] md:relative z-[5] rounded-[32px] p-[32px]`}>
