...
const Options = ({data}:{data:any}) => {
   ...
   return (
      <div className='mb-[35px] '>
         <button onClick={()=>setActive(!active)} className={`py-[10px] mb-[5px] ${active?'text-[var(--white-100)]':'text-[var(--white-06)]'} transition-colors font-[300] border-0 border-solid border-b-[1px] border-b-[--white-02]  flex items-center justify-between w-full`}>
