...
const Phone = () => {
   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`z-[1] flex items-center justify-center text-[13px] font-[900] font-[var(--third-family)]  absolute left-[115px] top-[30px] w-[50px] h-[30px] bg-[var(--sunrise-100)]`}>
            {time}
         </div>
