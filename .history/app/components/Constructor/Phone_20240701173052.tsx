   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`relative z-[2] lg:px-[40px] px-[30px]  lg:py-[80px] py-[50px] `}>
            ...
            <ul className='flex items-center justify-between mt-[20px] font-[400] text-[10px]'>
               {
                  constructorData.phone.footer.map(el=>(
                     <li key={el.id} className='flex flex-col items-center justify-end'>
                        <Image className='w-auto mt-[13px]' src={constructorData.phone.bigBanner.img} quality={100} alt={constructorData.phone.bigBanner.text} width={25} height={25} />
                        {el.text}
                     </li>
                  ))
               }
