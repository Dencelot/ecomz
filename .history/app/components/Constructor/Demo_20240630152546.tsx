...
const Demo = () => {
   return (
         <div className='md:w-1/3 bg-[var(--sunrise-01)] 2xl:text-[25px]  text-[20px] rounded-[32px] p-[32px]'>
            ...
            <Btn isDemo text={constructorData.demo.btn} classNames={'ext-[24px] leading-[1.3] text-[var(--white-100)] md:rounded-[20px] rounded-[30px] md:py-[45px] py-[19px] bg-[var(--bazalt-100)] w-full transition-colors hover:bg-[var(--black-90)]'}/>
         </div>
   )
}
