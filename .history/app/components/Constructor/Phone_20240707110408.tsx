   ...
   return (
      <div  className={`fontF${filters.fonts.code} xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         <div className='absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bgPhone aspect-square h-full'>
            ...
            <path d="M1015.5 507.5C1015.5 787.785 788.285 1015 508 1015C227.715 1015 0.5 787.785 0.5 507.5C0.5 227.215 227.715 0 508 0C788.285 0 1015.5 227.215 1015.5 507.5Z" fill={""} />
            <defs>
