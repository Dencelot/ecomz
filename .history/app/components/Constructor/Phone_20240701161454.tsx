...
const Phone = () => {
   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`z-[1] flex items-center justify-center lg:text-[13px] text-[11px] font-[900] font-[var(--third-family)]  absolute lg:left-[115px] left-[60px] lg:top-[25px] top-[15px] w-[50px] h-[30px] bg-[var(--white-100)]`}>
            {time}
         </div>
