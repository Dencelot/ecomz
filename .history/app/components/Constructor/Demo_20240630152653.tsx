...
const Demo = () => {
   return (
         <div className='md:w-1/3 bg-[var(--sunrise-01)] 2xl:text-[25px]  text-[20px] rounded-[32px] p-[32px]'>
            ...
            <Btn isDemo text={constructorData.demo.btn} classNames={'rounded-[20px] bg-[var(--white-100)] text-[var(--bazalt-100)] hover:bg-[var(--white-100)] hover:text-[var(--bazalt-100)] transition-colors'}/>
         </div>
   )
}
