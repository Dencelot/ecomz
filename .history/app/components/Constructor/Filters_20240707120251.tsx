...
const Filters = () => {
   ...
   return (
      <div className={`${active?' top-[80px] left-0 md:bg-[var(--neon-01)] bg-[var(--bazalt-100)]':'-left-[80%] bg-[var(--neon-01)]'} w-full  fixed  md:w-1/3 h-fit md:bg-[var(--neon-01)] 2xl:text-[25px]  text-[20px] md:relative z-[5] rounded-[32px] p-[32px]`}>
