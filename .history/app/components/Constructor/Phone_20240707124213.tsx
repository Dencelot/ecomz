...
const Phone = () => {
   ...
   return (
      <div  className={`fontF${filters.fonts.code} xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
                     ...
                     constructorData.phone.catalog[filters.types.id].map(el=>(
                        <SwiperSlide key={el.id} className='' style={{height:'auto'}}>
                           <article className='flex flex-col h-full'>
                              <div className='mb-[10px] overflow-hidden rounded-[2px] relative h-[136px] flex items-center justify-center'>
                                 ...
                                 <Image className='w-full max-h-full object-contain ' quality={100} alt={el.text} src={el.img} width={134} height={126}/>
                              </div>
