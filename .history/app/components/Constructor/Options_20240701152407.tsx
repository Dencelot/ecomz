...
const Options = ({data}:{data:any}) => {
   ...
   return (
      <div className='mb-[30px] '>
         <button onClick={()=>setActive(!active)} className='py-[10px] mb-[40px]  font-[300] border-0 border-solid border-b-[1px] border-b-[--white-02] text-[var(--white-06)] flex items-center justify-between w-full'>
