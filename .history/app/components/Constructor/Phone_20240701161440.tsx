...
const Phone = () => {
   ...
   return (
      <div className={`xl:px-[56px] px-[20px] flex-none xl:w-[510px] w-[340px] relative text-[var(--bazalt-100)]`}>
         ...
         <div className={`z-[1] flex items-center justify-center lg:text-[13px] text-[12px] font-[900] font-[var(--third-family)]  absolute lg:left-[115px] left-[60px] lg:top-[25px] top-[15px] w-[50px] h-[30px] bg-[var(--sunrise-100)]`}>
            {time}
         </div>
            ...
            <Swiper>
               {
                  constructorData.phone.smallBanners.map(el=>(
                     <SwiperSlide>
                        <div className={`relative w-[143px] p-[10px] h-[143px] flex items-center justify-center font-[400] text-[var(--white-100)] text-[16px] text-center`}>
                           <p className='relative z-[1]'>
                              {el.text}
                           </p>
                           <Image className='z-0 w-auto h-auto absolute top-[5px] left-[5px] right-[5px] bottom-[5px]' src={el.img} quality={100} alt={el.text} width={138} height={138} />
                        </div>
                     </SwiperSlide>
                  ))
               }
