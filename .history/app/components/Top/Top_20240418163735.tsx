...
const Top = () => {
  return (
   <section className="pt-[96px] sm:pt-0 container relative text-[var(--white-100)] h-screen minH flex items-start sm:flex-row flex-col">
      <Image quality={100} className="z-[1] top-1/2 -translate-y-1/2  right-0 w-full h-auto absolute :block hidden object-contain " width={1700} height={1000} alt="bg" src={'/img/bgmain.jpg'}/>
