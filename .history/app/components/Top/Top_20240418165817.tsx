...
const Top = () => {
  return (
   <section className=" pt-[96px] sm:pt-0 container relative text-[var(--white-100)] h-screen minH flex items-start sm:flex-row flex-col">
      ...
      <Image quality={100} className="z-[1] top-0 left-0 right-0 h-full object-bottom w-full absolute block sm:hidden" width={900} height={1500} alt="bg" src={'/img/bgmainmobile.jpg'}/>
