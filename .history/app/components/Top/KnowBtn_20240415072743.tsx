...
const KnowBtn = () => {
  return (
    <button className='absolute bottom-[40px] xl:right-[120px] right-[40px] z-[2] transition-opacity hover:opacity-75 hidden sm:flex flex-col items-center justify-center'>
