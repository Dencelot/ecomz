...
const Top = () => {
  return (
   <div className="container relative text-[var(--white-100)] h-screen minH">
      ...
      <Image quality={100} className="z-[1] top-0 md:left-0 left-[-100px] w-[calc(100%+100px)] right-0 h-full object-left absolute hidden sm:block xl:hidden" width={2000} height={1070} alt="bg" src={'/img/bgmainmiddle.jpg'}/>
