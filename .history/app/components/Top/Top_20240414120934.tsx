...
const Top = () => {
  return (
   <div className="container relative text-[var(--white-100)] h-screen minH">
      ...
      <Image quality={100} className="z-[1] top-0 left-0 right-0 h-full translate-x-[50px] lg:object-left absolute hidden sm:block xl:hidden" width={2000} height={1070} alt="bg" src={'/img/bgmainmiddle.jpg'}/>
