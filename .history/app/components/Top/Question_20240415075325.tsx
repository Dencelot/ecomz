...
const Question = () => {
  return (
    <div className='absolute sm:left-[40px] left-0 md:left-auto sm:right-[40px] md:top-1/2 sm:-translate-y-1/2   sm:bottom-[40px] bottom-0  z-[2] w-full sm:w-auto md:w-[40%] flex items-start justify-center '>
