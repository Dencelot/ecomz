...
const Question = () => {
  return (
    <div className='relative z-[2] sm:w-1/2 flex items-start justify-center pt-[10%]'>
      <div className='bg-[var(--neon-01)] rounded-[32px] p-[16px] w- max-w-[537px] flex items-center justify-between'>
