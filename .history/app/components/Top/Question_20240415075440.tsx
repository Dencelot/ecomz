...
const Question = () => {
  return (
    <div className='absolute sm:left-[40px] h-max left-0 md:left-auto md:right-[40px] md:top-1/2 md:-translate-y-[0%]   sm:bottom-[40px] bottom-0  z-[2] w-full sm:w-auto md:w-[40%] flex items-start justify-center '>
