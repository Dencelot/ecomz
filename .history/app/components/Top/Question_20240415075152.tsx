...
const Question = () => {
  return (
    <div className='absolute sm:left-[40px] left-0 sm:bottom-[40px] md:bottom-0 bottom-0 md:relative z-[2] w-full sm:w-auto md:w-[40%] flex items-start justify-center '>
