...
const Question = () => {
  return (
    <div className='absolute sm:left-[40px] left-0 sm:bottom-[40px] bottom-0 md:relative z-[2] w-full sm:w-auto md:w-[40%] flex items-start justify-center md:pt-[20%]'>
      <div className= 'bg-[var(--black-09)] md:bg-[var(--neon-01)] rounded-[32px] p-[16px] w-full sm:max-w-[537px] flex items-center justify-between'>
         ...
         <button className='hover:bg-[var(--sunrise-40)] transiti bg-[var(--white-100)] text-[var(--bazalt-100)] rounded-[20px] xxs:px-[40px] px-[20px] py-[16px] xxs:text-[18px] text-[16px]'>
