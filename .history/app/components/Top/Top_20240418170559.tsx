...
const Top = () => {
  return (
   <section className=" pt-[96px] sm:pt-0 container relative text-[var(--white-100)] h-screen minH flex items-start sm:flex-row flex-col">
      ...
      <Image quality={100} className="z-[1] top-0 left-0 right-0  h-full  lg:object-left absolute hidden xs:block xl:hidden" width={2000} height={1350} alt="bg" src={'/img/bgmainmiddle.jpg'}/>
