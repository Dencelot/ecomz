...
const Top = () => {
  return (
   <section className=" pt-[96px] sm:pt-0 container relative text-[var(--white-100)] h-screen minH flex items-start sm:flex-row flex-col">
      ...
      <Image quality={100} className="z-[1] top-[80px] left-0 right-0 bottom-[40px] h-[calc(100%-140px)] object-bottom w-full absolute block xs:hidden" width={900} height={1500} alt="bg" src={'/img/bgmainmobile.jpg'}/>
