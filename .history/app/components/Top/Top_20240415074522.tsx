...
const Top = () => {
  return (
   <section className="pt-[96px] sm:pt-0 container relative text-[var(--white-100)] h-screen minH flex items-start sm:flex-row flex-col">
      <Image quality={100} className="z-[1] top-0 left-1/2 -translate-x-1/2 h-full w-auto absolute xl:block hidden object-contain " width={1600} height={670} alt="bg" src={'/img/bgmain.jpg'}/>
