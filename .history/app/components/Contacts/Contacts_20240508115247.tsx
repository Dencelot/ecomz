...
export const Contacts = () => {
  ...
  return (
    <section
      className={`flex-auto w-full transition-[transform,opacity] minH pt-[96px] md:pt-[120px] h-svh  fixed z-50 bg-[var(--bazalt-100)] ${
        modals.contacts ? 'translate-x-0' : 'translate-x-full opacity-0'
      }`}
    >
      <div className='relative flex 2xl:pl-5 pl-[40px] items-stretch justify-between gap-x-20 w-full h-full'>
        ...
        <YandexMap />
        <Image
          className='hidden lg:block absolute top-[224px] 2xl:left-[400px] left-[400px]'
          src={Logo}
          alt='Ecomz logo'
          width={212}
          height={212}
