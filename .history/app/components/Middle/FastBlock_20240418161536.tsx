...
const FastBlock = ({item}:{item:any}) => {
  ...
  return (
   <article  className={` xl:text-[18px] text-[15px]   relative  m-[16px] text-[var(--black-40)] h-[375px]`}>
      ...
      <Image className=' absolute bottom-0 left-0 h-[325px] w-[512px] w-auto object-none object-left' alt={item.title} width={1000} height={632} src={`/img/middle/${item.id}.png`}/>
