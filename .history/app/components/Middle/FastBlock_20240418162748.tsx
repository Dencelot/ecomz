...
const FastBlock = ({item}:{item:any}) => {
  ...
  return (
   <article  className={` xl:text-[18px] text-[15px]  sm:w-auto w-full relative  m-[16px] text-[var(--black-40)] md:h-[375px] h-[380px]`}>
      ...
      <Image className=' absolute bottom-0 left-0 md:h-[325px] md:w-[512px] sm:h-[200px] h-[3154px] w-auto object-fill max-w-none' alt={item.title} width={1000} height={632} src={`/img/middle/${item.id}.png`}/>
