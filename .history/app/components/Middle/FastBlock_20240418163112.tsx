...
const FastBlock = ({item}:{item:any}) => {
  ...
  return (
   <article  className={` xl:text-[18px] text-[15px]  w-full relative  m-[16px] text-[var(--black-40)] md:h-[395px] sm:h-[340px] xs:h-[380px] h-[340px]`}>
      ...
      <Image className=' absolute bottom-0 left-0 md:h-[325px] md:w-[512px] sm:h-[200px] xs:h-[350px] h-[300px] w-auto object-fill max-w-none' alt={item.title} width={1000} height={632} src={`/img/middle/${item.id}.png`}/>
