...
const FastArticle = ({item}:{item:any}) => {
  ...
  return (
   <article onClick={handleClick} className={`art xl:text-[18px] text-[15px] xl:p-[40px] p-[20px] relative cursor-pointer min-h-[258px] m-[16px]`}>
      ...
      <h3 className='xl:text-[32px] sm:text-[26px] text-[20px] sm:leading-[1.31] leading-[1.31] mb-[16px]'>
         {item.title}
      </h3>
