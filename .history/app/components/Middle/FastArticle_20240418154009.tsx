...
const FastArticle = ({item}:{item:any}) => {
  ...
  return (
   <article onClick={handleClick} className={`art xl:text-[18px] text-[15px] xl:p-[40px] p-[20px] relative cursor-pointer md:min-h-[258px] m-[16px]`}>
      <button className={`transition-transform ${active&&'rotate-45'} absolute xl:top-[20px] xl:right-[20px] top-[10px] right-[10px]`}>
