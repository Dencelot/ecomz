               ...
               <div className='h-1/2   2xl:pt-[16px] md:pt-[12px] pt-[8px]'>
                  <div className='bg-[var(--black-90)] rounded-[30px] border-[1px] border-solid border-[var(--black-50)] border-l-0 rounded-l-none h-full flex flex-col '>
                     <div className='flex-auto   relative  z-[2]'>
                        <Picture width={500} height={1000} className=' h-full absolute bottom-0 right-0 max-w-none sm:w-auto xxss:w-[400px] object-bottom sm:rounded-[0px] xxss:rounded-[30px]' src={data.middle.possibilities.first.slider[3].img2} alt={data.middle.possibilities.first.slider[3].title}/>
                     </div>
                  </div>
               </div>
