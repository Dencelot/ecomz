...
const Middle = () => {
  return (
    <section id='middle' className='relative  sm:mt-0 mt-[40px]'>
      ...
      <Image className='absolute z-[2] top-0 left-0 w-full xl:object-contain xl:h-auto sm:h-[200px] xxs:h-[150px] h-[120px]' alt="bg" src={'/img/topsection.png'} width={2160} height={216}/>
      <FastStart/>
   </section>
  )
}
