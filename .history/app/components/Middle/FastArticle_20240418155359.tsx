...
const FastArticle = ({item}:{item:any}) => {
  ...
  return (
   <article onClick={handleClick} className={`art xl:text-[18px] text-[15px] xl:p-[40px] p-[20px] pr-[70px] xl:pr-[40px] relative cursor-pointer md:min-h-[258px] m-[16px]`}>
      ...
      <h3 className='xl:text-[32px] sm:text-[26px] text-[20px] sm:leading-[1.31] leading-[1.6] mb-[16px] text-['>
         {item.title}
      </h3>
