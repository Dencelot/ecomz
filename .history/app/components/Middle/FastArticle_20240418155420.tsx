...
const FastArticle = ({item}:{item:any}) => {
  ...
  return (
   <article onClick={handleClick} className={`art xl:text-[18px] text-[15px] xl:p-[40px] p-[20px] pr-[70px] xl:pr-[40px] relative cursor-pointer md:min-h-[258px] m-[16px] text-[var(--black-40)]`}>
