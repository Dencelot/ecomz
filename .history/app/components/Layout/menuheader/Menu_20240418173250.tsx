...
const Menu = ({active}:{active:boolean}) => {
   return (
      <nav className={`md:relative absolute top-full right-0 md:top-auto`}>
         <ul className='text-right md:flex-row flex-col flex items-center md:h-[46px] md:rounded-[16px] md:overflow-hidden md:border-solid md:border-[1px] md:border-white'>
