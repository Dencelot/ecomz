   ...
   return (
      <nav>
         <ul className='flex items-center h-[46px] rounded-[16px] overflow-hidden border-solid border-[1px] border-white'>
            ...
            <li className='h-full'>
               <Link className='flex items-center justify-center h-full px-[16px] text-[var(--bazalt-100)] hover:bg-[var(--sunrise-40)] bg-[var(--white-100)] rounded-tl-[16px] rounded-tl-[16px] transition-colors' href={''}>{data.header.popup}</Link>
            </li>
         </ul>
      </nav>
   )
