...
const Menu = ({active}:{active:boolean}) => {
   return (
      <nav className={`${active?'md:translate-x-full':' md:translate-x-0 translate-x-full'} md:bg-inherit bg-[var(--bazalt-100)] md:h-auto h-screen md:relative absolute top-full right-0 md:top-auto`}>
