   ...
   return (
      <nav>
         <ul className='flex items-center h-[46px] rounded-[16px] border-solid border-[1px] border-white'>
            ...
            <li className='flex items-center justify-center h-full px-[16px['>
               <Link className='text-[var(--bazalt-100)] hover:bg-[var(--sunrise-40)] bg-[var(--white-100)] rounded-[16px] transition-colors' href={''}>{data.header.popup}</Link>
            </li>
         </ul>
      </nav>
   )
