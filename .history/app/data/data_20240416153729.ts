export const data = {
   ...
   middle:{
      ...
      texts:[
         ...
         быстрее сайта
         `,
         descrFull:`Приложения используют кэширование и более эффективные алгоритмы загрузки данных, чем веб-сайты, что способствует их быстрой работе.<br/><br/>
         ...
         },
         {
            ...
            с сайтом`,
            descrFull:`Бесшовная интеграция с сайтом означает, что приложение и сайт работают вместе, как единое целое.<br/><br/>
         ...
         },
         {
            ...
            title:`Интеграция
            с любыми сервисами`,
            descrFull:`Интеграция приложения с сервисами доставки, оплаты и пр. позволяет увеличить продажи и снизить затраты на доставку.<br/><br/>
